 ...
 * @author KNOWLES
 */
public class FMR_FaQ_AllQuestions extends javax.swing.JFrame {
     ...
     */
    public FMR_FaQ_AllQuestions(Account account) {
    ...
    private void initComponents() {
        ...
        BG.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 130, 570, 330));
    ...
    private void loadFaQsToTable() {
        try {
            ...
            jTable2.getColumnModel().getColumn(0).setPreferredWidth(100); // ID column
            jTable2.getColumnModel().getColumn(1).setPreferredWidth(220); // Question column
            jTable2.getColumnModel().getColumn(2).setPreferredWidth(250); // Answer column
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FMR_FaQ_AllQuestions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        /* Create and display the form */
        java.awt.EventQueue.invokeLater(() -> {
            new FMR_FaQ_AllQuestions(null).setVisible(true);
        });
    }
