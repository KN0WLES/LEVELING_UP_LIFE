 ...
 * @author ARUBIS
 */
public class FMR_ROOMS extends javax.swing.JFrame {
    private final Account account;
    //private final RoomController roomController;
    
    /**
     * Creates new form FMR_ROOMS
     */
    public FMR_ROOMS(Account account) {
    ...
    private void initComponents() {
        ...
        boton_tipoHabitaciones = new javax.swing.JToggleButton();
        ...
        boton_tipoHabitaciones.setBackground(new java.awt.Color(51, 153, 0));
        boton_tipoHabitaciones.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        boton_tipoHabitaciones.setForeground(new java.awt.Color(255, 255, 255));
        boton_tipoHabitaciones.setText("Ver Habitaciones");
        boton_tipoHabitaciones.setToolTipText("");
        boton_tipoHabitaciones.setAutoscrolls(true);
        boton_tipoHabitaciones.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        boton_tipoHabitaciones.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                boton_tipoHabitacionesActionPerformed(evt);
            }
        });
        BG.add(boton_tipoHabitaciones, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 460, -1, 30));
        ...
        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/rooms.jpg"))); // NOI18N
        BG.add(fondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 100, -1, -1));
    ...
    private void boton_tipoHabitacionesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_tipoHabitacionesActionPerformed
        FMR_RomsTipo newFrame = new FMR_RomsTipo(account);
        newFrame.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_boton_tipoHabitacionesActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FMR_ROOMS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new FMR_ROOMS(null).setVisible(true);
        });
    }
    ...
    private javax.swing.JToggleButton boton_tipoHabitaciones;
