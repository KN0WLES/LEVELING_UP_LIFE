 ...
 * @author ARUBIS
 */
public class FMR_RoomsDormitorio extends javax.swing.JFrame {
    private final Account account;
    private final RoomController roomController;
    /**
     * Creates new form FMR_DORMITORIO
     */
    public FMR_RoomsDormitorio(Account account) {
    ...
    private void loadIndividualRooms() {
        try {
            ...
            List<Room> individualRooms = roomController.getRoomsByType('D');
    ...
    private void initComponents() {
        ...
        titulo.setText("Salas - Dormitorios");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/dormitorio.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FMR_RoomsDormitorio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new FMR_RoomsDormitorio(null).setVisible(true);
        });
    }
