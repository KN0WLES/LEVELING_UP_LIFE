 ...
 * @author ARUBIS
 */
public class FMR_RoomsIndividual extends javax.swing.JFrame {
    /**
     * Creates new form FMR_INDIVIDUAL
     */
   private final Account account;
     ...
     */
    public FMR_RoomsIndividual(Account account) {
    ...
    private void loadIndividualRooms() {
        try {
            ...
            List<Room> individualRooms = roomController.getRoomsByType('I');
    ...
    private void initComponents() {
        ...
        titulo.setText("Salas - Individual");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/individual.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FMR_RoomsIndividual.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FMR_RoomsIndividual(null).setVisible(true);
            }
        });
    }
