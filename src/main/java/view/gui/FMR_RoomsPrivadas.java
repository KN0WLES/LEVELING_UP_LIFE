 ...
 * @author ARUBIS
 */
public class FMR_RoomsPrivadas extends javax.swing.JFrame {
    private final Account account;
    private final RoomController roomController;
    
    /**
     * Creates new form FMR_PRIVADO
     */
    public FMR_RoomsPrivadas(Account account) {
    ...
    private void loadIndividualRooms() {
        try {
            ...
            List<Room> individualRooms = roomController.getRoomsByType('P');
    ...
    private void initComponents() {
        ...
        BG.add(boton_volver, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 480, 130, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FMR_RoomsPrivadas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new FMR_RoomsPrivadas(null).setVisible(true);
        });
    }
